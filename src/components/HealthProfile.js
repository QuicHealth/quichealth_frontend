...
function HealthProfile() {
    return (
        <Container>
            <SideBar />
            <MainBodys>
                <BodyHeading><Avatar /><h3>Oluwatobi</h3></BodyHeading>
                <ProfileSection>
                    <SectionOne>
                        <Left>
                    ...
                    <SectionThree>
                        <FullLeft>
                            ...
                            <SelectBoxContainer>
                                <SelectBox>
                                        <input type="checkbox" />
                                        <label htmlFor="single" style={{padding: '0 .5em'}}>single</label>
                                </SelectBox>
                                <SelectBox>
                                    <input type="checkbox" />
                                    <label htmlFor="married" style={{padding: '0 .5em'}}>married</label>
                                </SelectBox>
                                <SelectBox>
                                    <input type="checkbox" />
                                    <label htmlFor="divorced" style={{padding: '0 .5em'}}>divorced</label>
                                </SelectBox>
                            </SelectBoxContainer>
                        </FullLeft>
                        <Right></Right>
